...
export const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-gray-900 dark:bg-gray-900 border-r border-gray-800 dark:border-gray-800 flex flex-col">
      {/* Logo */}
      <div className="p-6 border-b border-gray-800 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 dark:text-gray-400">{t.app.subtitle}</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-gray-800 dark:border-gray-800">
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-3 px-4 py-2 text-gray-400 dark:text-gray-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-all duration-200"
        >
