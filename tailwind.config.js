  ...
  theme: {
    extend: {
      colors: {
        ...
        // Используйте эти классы вместо gray-100, gray-400 и т.д.
        ...
        // Статусы - используют CSS переменные для автоматического переключения
      ...
      boxShadow: {
        ...
        'light-xl': '0 20px 25px -5px rgba(0, 0, 0, 0.15)',
        
        'dark-sm': '0 2px 4px 0 rgba(0, 0, 0, 0.6)',
        'dark-md': '0 4px 6px -1px rgba(0, 0, 0, 0.7)',
        'dark-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.8)',
        'dark-xl': '0 20px 25px -5px rgba(0, 0, 0, 0.9)',
